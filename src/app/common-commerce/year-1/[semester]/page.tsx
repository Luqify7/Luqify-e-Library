...
export default async function SemesterPage({
  ...
  const courses =
    commonCommerceCurriculum["year-1"][
      semester as keyof typeof commonCommerceCurriculum["year-1"]
    ];
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
            ...
            },
            {
              name:
                semester === "semester-1"
                  ? "Semester 1"
                  : "Semester 2",
              href: `/common-commerce/year-1/${semester}`,
            },
          ]}
        />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          {courses.map((course) => (
            ...
            <Link
              key={course.name}
              href={`/common-commerce/year-1/${semester}/${encodeURIComponent(
